...
<div class="container">
  ...
  <label for="name">LastName</label>
    ...
    <input type="text" class="form-control" id="email" placeholder="+254..." required>
    <br>
...
<h6>Programming Languages</h6>
                <div>
                <input type="radio" aria-label="PHP">PHP
                <input type="radio" aria-label="GO">Golang
                <input type="radio" aria-label="HTML">HTML
                <input type="radio" aria-label="GO">JQuery
                <input type="radio" aria-label="JS">JS
                <input type="radio" aria-label="CSS">CSS
                </div>
                <br>

<h6>Hobbies</h6>
<select class="custom-select custom-select-md mb-3">
  <option selected>Choose a hobby</option>
